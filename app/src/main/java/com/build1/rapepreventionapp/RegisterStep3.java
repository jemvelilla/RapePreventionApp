...
public class RegisterStep3 extends AppCompatActivity {
    ...
    public void btnOnClickRegInfo(View v){
        ...
        if (fName.getText().toString().trim().equals("")){
        ...
        }else if (cP1Num.getText().toString().trim().equals("")){
            cP1Num.setError("Field Required");
        }else if (cP2.getText().toString().trim().equals("")){
            cP2.setError("Field Required");
        }else if (cP2Num.getText().toString().trim().equals("")){
            cP2Num.setError("Field Required");
        }
        else{
            ...
            if (!cP3.getText().toString().trim().equals("") && !cP2Num.getText().toString().trim().equals("")) {
